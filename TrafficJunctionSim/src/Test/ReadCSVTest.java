...
class ReadCSVTest {
	...
	final void testGetHeaderValuesLessThanOneVehicleVehiclesCSV() {
		//this.main = new GUIMain();
		JunctionSim.vehiclesCSVFile = "TestData/VehiclesTestCSVs/test_vehicles_no_vehicles.csv";
	...
	final void testGetHeaderValuesBorderCaseOneVehicle() {
		//this.main = new GUIMain();
		JunctionSim.vehiclesCSVFile = "TestData/VehiclesTestCSVs/test_vehicles_one_vehicle.csv";
	...
	final void testGetHeaderValuesInvalidPhaseCount9PhasesCSV() {
		//this.main = new GUIMain();
		JunctionSim.vehiclesCSVFile = "TestData/IntersectionTestCSVs/test_intersection_invalid_9_phases.csv";
		assertThrows(InvalidFileFormatException.class,
	...
	final void testGetHeaderValuesInvalidPhaseCount7PhasesCSV() {
		//this.main = new GUIMain();
		JunctionSim.vehiclesCSVFile = "TestData/IntersectionTestCSVs/test_intersection_invalid_7_phases.csv";
		assertThrows(InvalidFileFormatException.class,
